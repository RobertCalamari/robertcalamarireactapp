            ...
            <div className="navbar">
                <div className="navbox">
                    <Link to="/" onClick={closeMenuBar}>
                        ...
                        <div className="nav-icon" style={pageColor === 1 ? {color:'#00c3ff'}: {}}>
                ...
                <div className="navbox">
                    <Link to="/about" onClick={closeMenuBar}>
                        <div className="nav-text">
                            ABOUT
                        </div>
                        <div className="nav-icon" style={pageColor === 2 ? {color:'#00c3ff'}: {}}>
                ...
                <div className="navbox">
                    <Link to="/projects" onClick={closeMenuBar}>
                        <div className="nav-text">
                            PROJECTS
                        </div>
                        <div className="nav-icon" style={pageColor === 3 ? {color:'#00c3ff'}: {}}>
                ...
                <div className="navbox">
                    <Link to="/art" onClick={closeMenuBar}>
                        <div className="nav-text">
                            ART
                        </div>
                        <div className="nav-icon" style={pageColor === 4 ? {color:'#00c3ff'}: {}}>
                ...
                <div className="navbox">
                    <Link to="/contact" onClick={closeMenuBar}>
                        <div className="nav-text">
                            CONTACT
                        </div>
                        <div className="nav-icon" style={pageColor === 5 ? {color:'#00c3ff'}: {}}>
